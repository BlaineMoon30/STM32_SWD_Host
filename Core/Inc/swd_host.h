...
typedef enum
{
  STM32F0_RDP_LEVEL_0 = 0,
  STM32F0_RDP_LEVEL_1 = 1,
  STM32F0_RDP_LEVEL_2 = 2
} stm32f0_rdp_level_t;

typedef enum
{
  STM32U0_RDP_LEVEL_0 = 0,
  STM32U0_RDP_LEVEL_1 = 1,
  STM32U0_RDP_LEVEL_2 = 2
} stm32u0_rdp_level_t;

typedef enum
{
  STM32L4_RDP_LEVEL_0 = 0,
  STM32L4_RDP_LEVEL_1 = 1,
  STM32L4_RDP_LEVEL_2 = 2
} stm32l4_rdp_level_t;
